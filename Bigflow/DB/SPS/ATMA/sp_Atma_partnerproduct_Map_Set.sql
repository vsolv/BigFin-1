...
if ls_Action = 'INSERT'  then
		...
		End if;
			...
			select JSON_UNQUOTE(JSON_EXTRACT(lj_filter,CONCAT('$.Mpartnerproduct_Partnerbranch_gid')))into @Mpartnerproduct_Partnerbranch_gid;
		...
		set Query_Insert=concat('insert into atma_map_tpartnerproduct(mpartnerproduct_partner_gid,mpartnerproduct_product_gid,
								mpartnerproduct_partnerbranch_gid,mpartnerproduct_unitprice,
								...
								,mpartnerproduct_isactive,mpartnerproduct_isremoved,entity_gid,create_by)
								values(',@Mpartnerproduct_Partner_gid,',',@Mpartnerproduct_Product_gid,',',@Mpartnerproduct_Partnerbranch_gid,',
                                ',@Mpartnerproduct_Unitprice,',
                                ',@Mpartnerproduct_Packingprice,',
                                ''',@Mpartnerproduct_Validfrom,''',
                                ''',@Mpartnerproduct_Validto,''',
                                ',@Mpartnerproduct_Deliverydays,',
                                ',@Mpartnerproduct_Capacitypw,',
                                ''',@Mpartnerproduct_Status,''',
                                ''N'',''Y'',
...
if ls_Action = 'DELETE'  then
		...
		set Query_Update = concat('update atma_map_tpartnerproduct set update_date = CURRENT_TIMESTAMP,update_by=',@Update_By,',mpartnerproduct_isactive=''N'',mpartnerproduct_isremoved=''Y''
