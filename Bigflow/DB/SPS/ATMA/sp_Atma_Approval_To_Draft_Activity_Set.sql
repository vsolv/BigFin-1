CREATE PROCEDURE `sp_Atma_Approval_To_Draft_Activity_Set`(in li_Action  varchar(30),
 ...
 SET finished1 =0;
	BEGIN
      ...
      set  @Mst_activitydetails='';
		...
		Newpartnerbranchgid,Oldpartnerbranch_gid,ad_activitydetails_gid,lj_classification,@Message);
