CREATE  PROCEDURE `sp_Atma_Pending_To_Approval_Taxdetails_Set`(in li_Action  varchar(30),
...
declare p_partnerbranch_code varchar(10);
...
IF li_Action='Insert' then
	...
	SELECT EXISTS(
         select true from  atma_tmp_mst_tpartnerbranch inner join  atma_tmp_mst_ttaxdetails on taxdetails_reftablecode=partnerbranch_code
