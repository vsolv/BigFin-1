CREATE DEFINER=`developer`@`%` PROCEDURE `sp_Atma_Approval_To_Draft_Set`(in li_Action  varchar(30),
...
IF li_Action='Approval_To_Draft_Set' then
	...
	set Query_Insert=concat('INSERT INTO atma_tmp_tpartner (partner_code,partner_name,partner_panno,partner_compregno,partner_group,partner_custcategorygid,
				...
				SELECT partner_code,partner_name,partner_panno,partner_compregno,partner_group,
                    partner_custcategorygid,partner_Classification,partner_type,partner_web,partner_activecontract,partner_reason_no_contract,partner_contractdatefrom,
					partner_contractdateto,partner_aproxspend,partner_actualspend,partner_noofdir,partner_orgtype,partner_renewaldate,partner_remarks,
					''',@Partner_Requestfor,''',''',@Partner_Status,''',partner_mainstatus,partner_renewdate,partner_rmname,
