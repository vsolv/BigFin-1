CREATE  PROCEDURE `sp_Atma_Pending_To_Approval_PR_Branch_Set`(
...
set Error_Level='ATMA54.6';
    ...
    select @NEWpartnerbranchgid;

		select main_partnerbranch_gid from atma_tmp_mst_tpartnerbranch
		where partnerbranch_partnergid=@Partner_Gid and partnerbranch_code=p_partnerbranch_code into @maingid_branch;
        #select p_partnerbranch_code;
        select @Partner_Gid_tmp,@NEWpartnerbranchgid,p_partnerbranch_gid;
