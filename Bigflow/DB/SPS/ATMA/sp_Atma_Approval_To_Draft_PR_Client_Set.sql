CREATE  PROCEDURE `sp_Atma_Approval_To_Draft_PR_Client_Set`(
...
BEGIN
	...
	/*
		...
		set Query_Update = concat('INSERT INTO  atma_tmp_mst_taddress
											  ( address_ref_code,address_district_gid,address_city_gid,address_state_gid,
                                                entity_gid, create_by,create_date,main_address_gid
                                                ',Query_Column,')
									    values (''',a_address_ref_code,''',',a_address_district_gid,',
												',ifnull(a_address_city_gid,''),',
												',ifnull(a_address_state_gid,''),',
