...
set Query_Select = '';
	set Query_Select =concat('select pc.partnerclient_partnergid,pc.partnerclient_name,pc.partnerclient_gid,a.address_1,
                            ...
                            inner join gal_mst_tdistrict d on a.address_district_gid=d.district_gid
							inner join gal_mst_tcity c on a.address_city_gid=c.city_gid
                            where pc.partnerclient_isactive=''Y'' and pc.partnerclient_isremoved=''N''
							and  s.state_isremoved=''N'' and d.district_isremoved=''N'' and c.city_isremoved =''N''
                            and pc.entity_gid=',@entity_gid,' and a.entity_gid=',@entity_gid,'
							and s.entity_gid=',@entity_gid,' and d.entity_gid=',@entity_gid,'
